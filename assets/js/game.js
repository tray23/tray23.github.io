...
ig.module("plugins.splash-loader").requires("impact.loader", "impact.animation").defines(function() {
    ig.SplashLoader = ig.Loader.extend({
        splashBackground: new ig.Image("media/graphics/splash/desktop/cover.png"),
        splashEmptyBar: new ig.Image("media/graphics/sprites/ingame/bar-empty.png"),
        splashLoadingBar: new ig.Image("media/graphics/sprites/ingame/bar.png"),
        loadingBarPos: {
            x: 240,
            y: 368
        },
...
ig.module("game.entities.props.prop-wall2").requires("impact.entity").defines(function() {
    EntityPropWall2 = ig.Entity.extend({
        ...
        zIndex: 30,
        gravityFactor: 0,
        animSheet: new ig.AnimationSheet("media/graphics/sprites/props/prop-wall2.png", 800, 600),
        init: function(b, c, d) {
            this.parent(b, c, d);
...
ig.module("game.entities.props.prop-money").requires("impact.entity").defines(function() {
    EntityPropMoney = ig.Entity.extend({
        ...
        type: ig.Entity.TYPE.B,
        objectAlpha: 0.018,
        animSheet: new ig.AnimationSheet("media/graphics/sprites/props/prop-money.png", 45, 51),
        init: function(b, c, d) {
            this.parent(b, c, d);
            this.addAnim("idle", 1, [0]);
            this.maxVel.y = 600;
...
ig.module("game.entities.props.prop-tree").requires("game.entities.ingame.enemy-control").defines(function() {
    EntityPropTree = EntityEnemyControl.extend({
        ...
        type: ig.Entity.TYPE.B,
        gravityFactor: 0,
        animSheet: new ig.AnimationSheet("media/graphics/sprites/props/prop-tree.png", 165, 250),
        init: function(b, c, d) {
            this.parent(b, c, d);
...
ig.module("game.entities.props.prop-water-machine").requires("game.entities.ingame.enemy-control").defines(function() {
    EntityPropWaterMachine = EntityEnemyControl.extend({
        ...
        type: ig.Entity.TYPE.B,
        gravityFactor: 0,
        animSheet: new ig.AnimationSheet("media/graphics/sprites/props/prop-water-machine.png", 85, 198),
        init: function(b, c, d) {
            this.parent(b, c, d);
            this.addAnim("idle", 1, [0]);
            this.originalPos.x = this.pos.x;
...
ig.module("game.entities.props.prop-desktop2").requires("impact.entity").defines(function() {
    EntityPropDesktop2 = ig.Entity.extend({
        ...
        type: ig.Entity.TYPE.B,
        gravityFactor: 0,
        animSheet: new ig.AnimationSheet("media/graphics/sprites/props/prop-desk2.png", 800, 313),
        init: function(b, c, d) {
            this.parent(b, c, d);
            this.addAnim("idle", 1, [0])
        },
...
ig.module("game.entities.props.prop-bulb-short").requires("impact.entity").defines(function() {
    EntityPropBulbShort = ig.Entity.extend({
        ...
        zIndex: 81,
        gravityFactor: 0,
        animSheet: new ig.AnimationSheet("media/graphics/sprites/props/prop-bulb-short.png", 320, 40),
        init: function(b, c, d) {
            this.parent(b, c, d);
...
ig.module("game.entities.props.prop-desk1").requires("impact.entity").defines(function() {
    EntityPropDesk1 = ig.Entity.extend({
        ...
        type: ig.Entity.TYPE.B,
        gravityFactor: 0,
        animSheet: new ig.AnimationSheet("media/graphics/sprites/props/prop-desk1.png", 800, 252),
        init: function(b, c, d) {
            this.parent(b, c, d);
            this.addAnim("idle", 1, [0])
        },
...
ig.module("game.entities.props.prop-wall1").requires("impact.entity").defines(function() {
    EntityPropWall1 = ig.Entity.extend({
        ...
        bgAlpha: 0.4,
        gravityFactor: 0,
        animSheet: new ig.AnimationSheet("media/graphics/sprites/props/prop-wall1.png", 800, 118),
        init: function(b, c, d) {
            this.parent(b, c, d);
            this.addAnim("idle", 1, [0]);
...
ig.module("game.entities.props.prop-bulb-long").requires("impact.entity").defines(function() {
    EntityPropBulbLong = ig.Entity.extend({
        ...
        zIndex: 120,
        gravityFactor: 0,
        animSheet: new ig.AnimationSheet("media/graphics/sprites/props/prop-bulb-long.png", 600, 100),
        init: function(b, c, d) {
            this.parent(b, c, d);
...
ig.module("game.entities.props.prop-title").requires("game.entities.ingame.enemy-control").defines(function() {
    EntityPropTitle = EntityEnemyControl.extend({
        ...
        originalPos: [],
        gravityFactor: 0,
        animSheet: new ig.AnimationSheet("media/graphics/sprites/props/prop-title.png", 518, 338),
        init: function(b, c, d) {
            this.parent(b, c, d);
            this.addAnim("idle", 1, [0]);
            this.tweenIn();
...
ig.module("game.entities.ingame.snowball").requires("impact.entity").defines(function() {
    EntitySnowball = ig.Entity.extend({
        ...
        type: ig.Entity.TYPE.A,
        checkAgainst: ig.Entity.TYPE.B,
        animSheet: new ig.AnimationSheet("media/graphics/sprites/ingame/snowball.png", 150, 134),
        init: function(b, c, d) {
            this.parent(b, c, d);
            this.addAnim("idle", 1, [0]);
...
ig.module("game.entities.buttons.btn-play").requires("impact.entity").defines(function() {
    EntityBtnPlay = ig.Entity.extend({
        ...
        zIndex: 200,
        gravityFactor: 0,
        animSheet: new ig.AnimationSheet("media/graphics/sprites/buttons/btn-play.png", 179, 82),
        init: function(b, c, d) {
            this.parent(b, c, d);
            this.addAnim("up", 1, [0]);
...
ig.module("game.entities.buttons.btn-more-games").requires("impact.entity").defines(function() {
    EntityBtnMoreGames = ig.Entity.extend({
        ...
        gravityFactor: 0,
        clicked: !1,
        animSheet: new ig.AnimationSheet("media/graphics/sprites/buttons/btn-more-games.png", 179, 82),
        init: function(b, c, d) {
            this.parent(b, c, d);
            this.addAnim("up", 1, [0]);
            this.addAnim("down", 0.1, [1]);
...
ig.module("game.entities.buttons.btn-reload").requires("impact.entity").defines(function() {
    EntityBtnReload = ig.Entity.extend({
        ...
        anim: null,
        animIdle: null,
        animSheet: new ig.AnimationSheet("media/graphics/sprites/buttons/btn-reload.png", 179, 82),
        snowball: new ig.AnimationSheet("media/graphics/sprites/ingame/snowball.png", 150, 134),
        snowballOffset: {
            x: 10,
            y: 10
        },
...
ig.module("game.entities.ingame.reticle").requires("impact.entity").defines(function() {
    EntityReticle = ig.Entity.extend({
        ...
        ignorePause: !0,
        gravityFactor: 0,
        animSheet: new ig.AnimationSheet("media/graphics/sprites/props/prop-reticle.png", 91, 91),
        init: function(b, c, d) {
            this.parent(b, c, d);
            this.addAnim("up", 1, [0]);
...
ig.module("game.entities.boards.board-pause").requires("impact.entity", "game.entities.ingame.reticle").defines(function() {
    EntityBoardPause = ig.Entity.extend({
        ...
        gravityFactor: 0,
        clicked: !1,
        animSheet: new ig.AnimationSheet("media/graphics/sprites/boards/board-pause.png", 542, 443),
        init: function(b, c, d) {
            this.parent(b, c, d);
            this.addAnim("idle", 1, [0]);
            this.pointer = ig.game.getEntitiesByType(EntityPointer)[0];
...
ig.module("game.entities.commons.music").requires("impact.entity").defines(function() {
    EntityMusic = ig.Entity.extend({
        ...
        gravityFactor: 0,
        zIndex: 401,
        animSheet: new ig.AnimationSheet("media/graphics/sprites/buttons/btn-sound.png", 31, 91),
        init: function(b, c, d) {
            this.parent(b, c, d);
            this.addAnim("up", 1, [0])
        },
...
ig.module("game.entities.buttons.btn-pause").requires("impact.entity", "game.entities.boards.board-pause").defines(function() {
    EntityBtnPause = ig.Entity.extend({
        ...
        type: ig.Entity.TYPE.B,
        zIndex: 200,
        animSheet: new ig.AnimationSheet("media/graphics/sprites/buttons/btn-pause.png", 55, 57),
        init: function(b, c, d) {
            this.parent(b, c, d);
            this.addAnim("up", 1, [0]);
            this.addAnim("down", 1, [1]);
...
ig.module("game.entities.props.prop-monitor1").requires("game.entities.ingame.enemy-control").defines(function() {
    EntityPropMonitor1 = EntityEnemyControl.extend({
        ...
        noticePos: [],
        sound: !1,
        animSheet: new ig.AnimationSheet("media/graphics/sprites/props/prop-monitor1.png", 147, 110),
        dimboFont: new ig.Font("media/text/dimbo-small-red-font.png"),
        init: function(b, c, d) {
            this.parent(b, c, d);
            this.addAnim("idle", 1, [0]);
...
ig.module("game.entities.props.prop-monitor2").requires("game.entities.ingame.enemy-control").defines(function() {
    EntityPropMonitor2 = EntityEnemyControl.extend({
        ...
        noticePos: [],
        sound: !1,
        animSheet: new ig.AnimationSheet("media/graphics/sprites/props/prop-monitor2.png", 117, 87),
        dimboFont: new ig.Font("media/text/dimbo-small-red-font.png"),
        init: function(b, c, d) {
            this.parent(b, c, d);
            this.addAnim("idle", 1, [0]);
...
ig.module("game.entities.props.prop-monitor3").requires("game.entities.ingame.enemy-control").defines(function() {
    EntityPropMonitor3 = EntityEnemyControl.extend({
        ...
        noticePos: [],
        sound: !1,
        animSheet: new ig.AnimationSheet("media/graphics/sprites/props/prop-monitor3.png", 127, 87),
        dimboFont: new ig.Font("media/text/dimbo-small-red-font.png"),
        init: function(b, c, d) {
            this.parent(b, c, d);
            this.addAnim("idle", 1, [0]);
...
ig.module("game.entities.props.prop-banner").requires("game.entities.ingame.enemy-control").defines(function() {
    EntityPropBanner = EntityEnemyControl.extend({
        ...
        gravityFactor: 0,
        life: 5,
        animSheet: new ig.AnimationSheet("media/graphics/sprites/props/prop-banner.png", 100, 90),
        init: function(b, c, d) {
            this.parent(b, c, d);
            this.addAnim("idle", 1, [0]);
...
ig.module("game.entities.enemies.enemy-boss").requires("game.entities.ingame.enemy-control", "game.entities.enemies.enemy-snowball").defines(function() {
    EntityEnemyBoss = EntityEnemyControl.extend({
        ...
        salaryGet: 1E3,
        ignorePause: !0,
        animSheet: new ig.AnimationSheet("media/graphics/sprites/enemies/boss.png", 451, 451),
        init: function(b, c, d) {
            this.parent(b, c, d);
...
ig.module("game.entities.enemies.enemy1").requires("game.entities.ingame.enemy-control", "game.entities.enemies.enemy-snowball").defines(function() {
    EntityEnemy1 = EntityEnemyControl.extend({
        ...
        salaryGet: 20,
        ignorePause: !0,
        animSheet: new ig.AnimationSheet("media/graphics/sprites/enemies/enemy1.png", 200, 240),
        init: function(b, c, d) {
            this.parent(b, c, d);
            this.addAnim("stand", 0.3, [0, 1]);
            this.addAnim("shoot", 0.2, [2, 3]);
...
ig.module("game.entities.enemies.enemy2").requires("game.entities.ingame.enemy-control", "game.entities.enemies.enemy-snowball").defines(function() {
    EntityEnemy2 = EntityEnemyControl.extend({
        ...
        salaryGet: 20,
        ignorePause: !0,
        animSheet: new ig.AnimationSheet("media/graphics/sprites/enemies/enemy2.png", 200, 240),
        init: function(b, c, d) {
            this.parent(b, c, d);
            this.addAnim("stand", 0.3, [0, 1]);
            this.addAnim("shoot", 0.2, [2, 3]);
...
ig.module("game.entities.enemies.enemy3").requires("game.entities.ingame.enemy-control", "game.entities.enemies.enemy-snowball").defines(function() {
    EntityEnemy3 = EntityEnemyControl.extend({
        ...
        salaryGet: 20,
        ignorePause: !0,
        animSheet: new ig.AnimationSheet("media/graphics/sprites/enemies/enemy3.png", 230, 240),
        init: function(b, c, d) {
            this.parent(b, c, d);
            this.addAnim("stand", 0.3, [0, 1]);
            this.addAnim("shoot", 0.2, [2, 3]);
...
ig.module("game.entities.enemies.enemy4").requires("game.entities.ingame.enemy-control", "game.entities.enemies.enemy-snowball").defines(function() {
    EntityEnemy4 = EntityEnemyControl.extend({
        ...
        salaryGet: 20,
        ignorePause: !0,
        animSheet: new ig.AnimationSheet("media/graphics/sprites/enemies/enemy4.png", 230, 240),
        init: function(b, c, d) {
            this.parent(b, c, d);
            this.addAnim("stand", 0.3, [0, 1]);
            this.addAnim("shoot", 0.2, [2, 3]);
...
ig.module("game.entities.enemies.enemy5").requires("game.entities.ingame.enemy-control", "game.entities.enemies.enemy-snowball").defines(function() {
    EntityEnemy5 = EntityEnemyControl.extend({
        ...
        salaryGet: 30,
        ignorePause: !0,
        animSheet: new ig.AnimationSheet("media/graphics/sprites/enemies/enemy5.png", 230, 240),
        init: function(b, c, d) {
            this.parent(b, c, d);
            this.addAnim("stand", 0.3, [0, 1]);
            this.addAnim("shoot", 0.2, [2, 3]);
...
ig.module("game.entities.enemies.enemy6").requires("game.entities.ingame.enemy-control", "game.entities.enemies.enemy-snowball").defines(function() {
    EntityEnemy6 = EntityEnemyControl.extend({
        ...
        salaryGet: 30,
        ignorePause: !0,
        animSheet: new ig.AnimationSheet("media/graphics/sprites/enemies/enemy6.png", 230, 240),
        init: function(b, c, d) {
            this.parent(b, c, d);
            this.addAnim("stand", 0.3, [0, 1]);
            this.addAnim("shoot", 0.2, [2, 3]);
...
ig.module("game.entities.enemies.enemy7").requires("game.entities.ingame.enemy-control", "game.entities.enemies.enemy-snowball").defines(function() {
    EntityEnemy7 = EntityEnemyControl.extend({
        ...
        salaryGet: 30,
        ignorePause: !0,
        animSheet: new ig.AnimationSheet("media/graphics/sprites/enemies/enemy7.png", 230, 240),
        init: function(b, c, d) {
            this.parent(b, c, d);
            this.addAnim("stand", 0.3, [0, 1]);
            this.addAnim("shoot", 0.2, [2, 3]);
...
ig.module("game.entities.enemies.enemy8").requires("game.entities.ingame.enemy-control", "game.entities.enemies.enemy-snowball").defines(function() {
    EntityEnemy8 = EntityEnemyControl.extend({
        ...
        salaryGet: 30,
        ignorePause: !0,
        animSheet: new ig.AnimationSheet("media/graphics/sprites/enemies/enemy8.png", 230, 240),
        init: function(b, c, d) {
            this.parent(b, c, d);
            this.addAnim("stand", 0.3, [0, 1]);
            this.addAnim("shoot", 0.2, [2, 3]);
...
ig.module("game.entities.ingame.ready1").requires("impact.entity").defines(function() {
    EntityReady1 = ig.Entity.extend({
        ...
        zIndex: 200,
        gravityFactor: 0,
        animSheet: new ig.AnimationSheet("media/graphics/sprites/ingame/ready1.png", 455, 101),
        init: function(b, c, d) {
            this.parent(b, c, d);
...
ig.module("game.entities.ingame.ready2").requires("impact.entity").defines(function() {
    EntityReady2 = ig.Entity.extend({
        ...
        zIndex: 200,
        gravityFactor: 0,
        animSheet: new ig.AnimationSheet("media/graphics/sprites/ingame/ready2.png", 455, 101),
        init: function(b, c, d) {
            this.parent(b, c, d);
            this.addAnim("shine", 0.15, [0]);
            this.tweenIn()
...
ig.module("game.entities.ingame.fight").requires("impact.entity").defines(function() {
    EntityFight = ig.Entity.extend({
        ...
        gravityFactor: 0,
        animSheet: new ig.AnimationSheet("media/graphics/sprites/ingame/fight.png", 419, 105),
        init: function(b, c, d) {
            this.parent(b, c, d);
...
ig.module("game.entities.ingame.player-life-bar").requires("impact.entity").defines(function() {
    EntityPlayerLifeBar = ig.Entity.extend({
        ...
        zIndex: 200,
        gravityFactor: 0,
        animSheet: new ig.AnimationSheet("media/graphics/sprites/ingame/bar-empty.png", 331, 38),
        bar: new ig.Image("media/graphics/sprites/ingame/bar.png"),
        init: function(b, c, d) {
            this.parent(b, c, d);
            this.addAnim("idle", 1, [0]);
            this.gameControl = ig.game.getEntitiesByType(EntityGameControl)[0]
...
ig.module("game.entities.ingame.bossComeFont").requires("impact.entity").defines(function() {
    EntityBossComeFont = ig.Entity.extend({
        ...
        Zindex: 200,
        gravityFactor: 0,
        animSheet: new ig.AnimationSheet("media/graphics/sprites/ingame/bossComeFont.png", 700, 250),
        init: function(b, c, d) {
            this.parent(b, c, d);
            this.addAnim("idle", 1, [0]);
            this.tweenIn()
...
ig.module("game.entities.boards.board-money").requires("impact.entity").defines(function() {
    EntityBoardMoney = ig.Entity.extend({
        ...
        ignorePause: !0,
        gravityFactor: 0,
        animSheet: new ig.AnimationSheet("media/graphics/sprites/boards/board-money.png", 239, 46),
        dimboFont: new ig.Font("media/text/dimbo-small-white-font.png"),
        dimboFontRed: new ig.Font("media/text/dimbo-small-red-font.png"),
        init: function(b, c, d) {
            this.parent(b, c, d);
            this.addAnim("idle", 1, [0]);
            this.gameControl = ig.game.getEntitiesByType(EntityGameControl)[0]
...
ig.module("game.entities.boards.board-gameover").requires("impact.entity").defines(function() {
    EntityBoardGameover = ig.Entity.extend({
        ...
        gravityFactor: 0,
        clicked: !1,
        animSheet: new ig.AnimationSheet("media/graphics/sprites/boards/board-gameover.png", 682, 409),
        dimboFont: new ig.Font("media/text/dimbo-small-red-font.png"),
        init: function(b, c, d) {
            this.parent(b, c, d);
            this.addAnim("idle", 1, [0]);
...
ig.module("game.entities.ingame.tutorial-bossWithTitle").requires("impact.entity").defines(function() {
    EntityTutorialBossWithTitle = ig.Entity.extend({
        ...
        gravityFactor: 0,
        zIndex: 210,
        animSheet: new ig.AnimationSheet("media/graphics/sprites/tutorial/boss-with-titleboard.png", 800, 600),
        dimboFont: new ig.Font("media/text/dimbo-small-red-font.png"),
        init: function(b, c, d) {
            this.parent(b, c, d);
            this.addAnim("idle", 1, [0]);
...
ig.module("game.entities.ingame.tutorial-btn-next").requires("impact.entity").defines(function() {
    EntityTutorialBtnNext = ig.Entity.extend({
        ...
        type: ig.Entity.TYPE.B,
        ignorePause: !0,
        animSheet: new ig.AnimationSheet("media/graphics/sprites/buttons/btn-next.png", 54, 67),
        init: function(b, c, d) {
            this.parent(b, c, d);
            this.addAnim("up", 1, [0]);
...
ig.module("game.entities.enemies.enemy-rat").requires("game.entities.ingame.enemy-control").defines(function() {
    EntityEnemyRat = EntityEnemyControl.extend({
        ...
        animWalk: null,
        dimboFont: new ig.Font("media/text/dimbo-small-white-font.png"),
        mouse: new ig.AnimationSheet("media/graphics/sprites/enemies/enemy-rat.png", 69, 90),
        mouseOffset: {
            x: 10,
            y: 10
        },
...
ig.module("game.levels.main-menu").requires("impact.image", "game.entities.props.prop-wall2", "game.entities.props.prop-tree", "game.entities.props.prop-water-machine", "game.entities.props.prop-desktop2", "game.entities.props.prop-bulb-short", "game.entities.props.prop-desk1", "game.entities.props.prop-wall1", "game.entities.props.prop-bulb-long", "game.entities.ingame.game-control").defines(function() {
    LevelMainMenu = {
        ...
        layer: [{
            ...
            linkWithCollision: !1,
            visible: 1,
            tilesetName: "media/graphics/sprites/props/prop-bg.png",
            repeat: !1,
            preRender: !0,
            distance: "1",
            tilesize: 20,
    ...
    LevelMainMenuResources = [new ig.Image("media/graphics/sprites/props/prop-bg.png")]
});
ig.baked = !0;
